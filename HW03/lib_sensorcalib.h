...
#define SONA_SOFAR 			3   //Test of sofar
...
static int color_value[MAX_COLOR_LEVEL] = {0,4,7};
static int sound_value[MAX_SOUND_LEVEL] = {932, 780, 395, 63};
static int sona_value[MAX_SONA_LEVEL] = {0, };
static int sona_4value[MAX_SONA_4LEVEL] = {0,20 ,40,60};
